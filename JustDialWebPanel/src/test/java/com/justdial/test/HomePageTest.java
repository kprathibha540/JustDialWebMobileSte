...
public class HomePageTest extends CommonUtilities{
	...
	@Test(priority=5, dataProvider = "NotAvailableData", dataProviderClass = DataProviderInput.class, enabled =true)
    ...
    public void verifyDetectedCityCompanyAutoSuggestDisplay(String compName) throws InterruptedException
    {
    	...
    	Thread.sleep(5000);
    	//hp.verifyCompanySearchResult(compName);
    	
    }
    @Test(priority=11, dataProvider = "SingleCharacter",dataProviderClass = DataProviderInput.class, enabled=false)
