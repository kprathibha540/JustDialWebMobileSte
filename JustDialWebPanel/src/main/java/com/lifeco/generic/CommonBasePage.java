...
public class CommonBasePage extends CommonUtilities
{
...
public void verifySearchResult( List<WebElement> searchResult,String expected)
{
	  for(int i=0;i<searchResult.size();i++)
	  {
		  ...
		  {
			  logs.info("  Verification not done  Actual data  is =" +actual+ " But expected is "+expected );
			  Assert.fail();
		  }
	  }
}
...
public void click(WebElement toClick)
{
	try {
			...
			scrollUpToTheElement(driver, toClick);
